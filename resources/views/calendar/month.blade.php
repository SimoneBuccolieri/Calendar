        ...
        <div class="flex flex-col space-y-6 ">
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex items-center md:space-x-2">
                    ...
                    <a href="{{ route('calendar.month', ['date' => today()->copy()->toDateString()]) }}" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium border border-gray-200 hover:bg-gray-200 h-10 px-1 md:px-4 py-2 text-xs md:text-base">
                        Today
                    </a>
                    <a href="{{ route('calendar.month', ['date' => $date->copy()->addMonth()->toDateString()]) }}" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium border border-gray-200 hover:bg-gray-200 px-1 h-10 px-1 md:px-4 py-2 text-xs md:text-base">
                        Month &raquo;
                    </a>
