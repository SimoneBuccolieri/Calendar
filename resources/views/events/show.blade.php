...
@section('content')
    <div class="container mx-auto py-8 px-4">
        ...
        <div class="inline-flex gap-4">
            ...
            <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium border border-gray-200 hover:bg-gray-200 h-10 px-1 md:px-4 py-2 text-xs md:text-base" href="{{route('events.destroy',$event)}}">Delete</a>
        </div>
    </div>
@endsection
